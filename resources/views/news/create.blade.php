                    ...
                    <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title"
                                ...
                                value="{{ old('title') }}" placeholder="Bijv. Wedstrijdverslag U21">
                            @error('title')
                        ...
                        <div>
                            ...
                            <textarea name="content" rows="6"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition duration-200"
                                placeholder="Schrijf hier je bericht...">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        {{-- Afbeelding --}}
                        <div>
                            <label class="block font-medium text-gray-700 mb-2">Afbeelding (optioneel)</label>
